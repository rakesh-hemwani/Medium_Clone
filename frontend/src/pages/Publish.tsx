    ...
    return <div>
        ...
        <div className="flex justify-center w-full pt-6">
            <div className="max-w-screen-lg w-full">
                ...
                }} type="text" id="helper-text" aria-describedby="helper-text-explanation" className="bg-gray-50 
                border border-gray-300 text-gray-900 text-sm rounded-md focus:outline-none block w-full p-2.5 " placeholder="Title" />
                <TextArea onChange={(e) => {
        ...
        <form>
            <div className="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50">
                ...
                <div className="px-4 py-2 bg-white rounded-b-lg">
                    ...
                    <textarea onChange={onChange} id="editor" rows={8} className=" focus:outline-none block w-full px-0 text-sm text-gray-800 bg-white" placeholder="Write an article..." required ></textarea>
                </div>
            </div>
